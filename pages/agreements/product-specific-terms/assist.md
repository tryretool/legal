...
- “**Assist Prompt**” means any data entered by Customer into Assist Beta, including prompts and natural language instructions, to generate Suggestions. “Assist Prompt” will exclude User Feedback (as defined below).
...
- “**Suggestion**” means any data generated and returned by Assist Beta to Customer based on the Assist Prompt.
...
**2.4 User Feedback.** If Customer labels a Suggestion with a “thumbs up” or “thumbs down” reaction and submits feedback to Retool (“User Feedback”), Customer consents to the Assist Prompt, along with other related data as described in the applicable Documentation, being shared with Retool and Retool’s third parties for Retool’s product improvement purposes. Customer is not required to submit User Feedback.
...
**3.3.2 Enterprise subscription plan.** If Customer is using Assist Beta under an “Enterprise Platform (Cloud)” subscription as set forth in its current Order Form, Retool will not use Assist Prompts, Suggestions, or other related data to enhance, improve or develop Assist Beta, including through model training or fine-tuning, unless Customer has opted in to such use by following instructions supplied by Retool.
